...
/**
 * Palabras clave que activan emociones específicas.
 */
...
/**
 * Analiza un mensaje y retorna los deltas emocionales.
 */
export function analyzeMessageEmotions(message: string): Partial<PlutchikEmotionState> {
  ...
  // BASELINE: Toda interacción aumenta ligeramente joy y trust
  deltas.joy = 0.02;
  deltas.trust = 0.02;
...
/**
 * Aplica deltas emocionales al estado actual con decay.
 */
...
export function emotionStateToPAD(state: PlutchikEmotionState): {
  ...
  // DOMINANCE: Emociones de control vs sumisión
...
/**
 * Actualiza InternalState en la base de datos.
 */
