...
export function generateHairLong_02(): string {
  return `
    <svg width="64" height="64" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- HAT_FRONT (8x8) at (40,8) - Solo HIGHLIGHTS (15 píxeles de 28 total) -->
      <!-- Fila superior completa (highlights brillantes) -->
      ...
      <!-- Fila y=9: laterales + centro (solo tonos claros) -->
      ...
      <!-- Fila y=10: solo extremos laterales (ondulación 3D) -->
