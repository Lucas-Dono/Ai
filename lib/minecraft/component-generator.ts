 ...
 * Mapeo: HEAD_FRONT (8,8)-(15,15) → eyes (0,0)-(7,7)
 */
export function generateEyes_Lob(): string {
  return `
    <svg width="8" height="8" xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges">
      <!-- Fila y=2 (HEAD y=10): Ojos blancos base -->
