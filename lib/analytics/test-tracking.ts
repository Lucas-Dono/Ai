 ...
 *
 * Verifica que las funciones de tracking funcionen correctamente.
 * Ejecutar con: npx ts-node --compiler-options '{"module":"commonjs"}' lib/analytics/test-tracking.ts
 */
...
async function runTests() {
  ...
  // En navegador deberías ver UTM params si están en la URL
  ...
  // En browser, esto mostraría toda la info
  ...
  // Verificar que se generó nuevo session ID después de clear
