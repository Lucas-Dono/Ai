 ...
 * Analytics Types
 *
 * Tipos y enums para el sistema de tracking de analytics.
 * Basado en ANALYTICS-IMPLEMENTATION-SUMMARY.md
 */
...
/**
 * Eventos de Landing Page (pre-signup)
 */
...
/**
 * Eventos de App (post-signup, UI interactions)
 */
...
/**
 * Eventos de Conversión (funnel crítico)
 */
