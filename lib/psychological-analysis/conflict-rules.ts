 ...
 *
 * Define 30+ reglas de detección de conflictos psicológicos basadas en:
 * - Inconsistencias Big Five ↔ Facetas
 * - Conflictos conductuales (rasgos que colisionan)
 * - Dark Triad extremo
 * - Apego contradictorio
 * - Cross-dimensional conflicts
 *
 * @version 1.0.0
 */

import type { ConflictRule, EnrichedPersonalityProfile } from './types';
...
export const FACET_BIG_FIVE_MISMATCH: ConflictRule = {
  ...
  detect: (p) => {
    ...
    // Calcular desviación promedio entre Big Five y promedio de facetas
    ...
    return avgDeviation > 20; // Desviación promedio >20 puntos
  },
...
/**
 * Todas las reglas de detección de conflictos.
 * Total: 19 reglas (expandible a 30-40).
 */
