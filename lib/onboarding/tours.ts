...
/**
 * Hook que devuelve los tours de onboarding con traducciones aplicadas
 * Usar este hook en componentes client-side
 */
      ...
      steps: [
          ...
          validation: {
            ...
            customCheck: () => {
              ...
              if (messagesContainer) {
                const messages = messagesContainer.textContent || '';
                // Si ya se mencionó "propósito", significa que se completó personality
        ...
        // STEP 4: PURPOSE INPUT
        {
          ...
          validation: {
            type: "custom",
            customCheck: () => {
              // Verificar que haya avanzado más allá del paso de propósito
              // El siguiente paso es physical appearance
              const messagesContainer = document.getElementById('messages-container');
              if (messagesContainer) {
                const messages = messagesContainer.textContent || '';
                // Si ya se mencionó "apariencia física", significa que se completó el purpose
        ...
        // STEP 5: PHYSICAL APPEARANCE SELECTION
        {
          ...
          validation: {
            ...
            customCheck: () => {
              ...
              if (messagesContainer) {
                const messages = messagesContainer.textContent || '';
                // Si ya se mencionó "avatar" o "foto", significa que se completó physical appearance
        ...
        // STEP 6: AVATAR IMAGE SELECTION
        {
          ...
          validation: {
            ...
            customCheck: () => {
              ...
              if (messagesContainer) {
                const messages = messagesContainer.textContent || '';
                // Si ya se mencionó "imagen de referencia" o "cuerpo completo", significa que se completó avatar
        ...
        // STEP 7: REFERENCE IMAGE SELECTION
        {
          ...
          validation: {
            ...
            customCheck: () => {
              ...
              if (messagesContainer) {
                const messages = messagesContainer.textContent || '';
                // Si ya se mencionó "nsfw" o "contenido adulto", significa que se completó reference image
        ...
        // STEP 8: NSFW MODE SELECTION
        {
          ...
          validation: {
            ...
            customCheck: () => {
              ...
              if (messagesContainer) {
                const messages = messagesContainer.textContent || '';
                // Si ya se mencionó "traumas" o "desarrollo emocional", significa que se completó nsfw mode
        ...
        // STEP 9: ALLOW DEVELOP TRAUMAS
        {
          ...
          validation: {
            ...
            customCheck: () => {
              ...
              if (messagesContainer) {
                const messages = messagesContainer.textContent || '';
                // Si ya se mencionó "comportamiento inicial" o "patrones", significa que se completó allow traumas
        ...
        // STEP 10: INITIAL BEHAVIOR SELECTION
        {
          ...
          validation: {
            ...
            customCheck: () => {
              ...
              // Esto se indica por la aparición del botón "Ir al chat" o mensaje de éxito
              const messagesContainer = document.getElementById('messages-container');
              if (messagesContainer) {
                const messages = messagesContainer.textContent || '';
        ...
        },
        {
          ...
          validation: {
            ...
            customCheck: async () => {
              ...
              // 1. Verificar si hay un parámetro en la URL que indique que volvió de crear post
              ...
              // También aceptamos si el usuario está en la página de crear post o acaba de regresar
              const isOnCreatePage = window.location.pathname.includes('/community/create');
...
/**
 * Obtiene el siguiente tour después del actual
 * NOTA: Usar solo dentro de componentes que usen useOnboardingTours()
 */
...
/**
 * Lista estática de IDs de tours (para uso en contextos sin traducciones)
 * Útil para verificar IDs sin necesitar cargar traducciones
 */
