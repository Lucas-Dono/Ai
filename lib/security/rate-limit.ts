 ...
 *
 * Características:
 * - Usa Upstash Redis si está configurado (recomendado para producción)
...
/**
 * Rate limiter con Upstash Redis (producción)
 * Si UPSTASH_REDIS_REST_URL no está configurado, retorna null
 */
...
/**
 * Rate limiter en memoria (fallback para desarrollo)
