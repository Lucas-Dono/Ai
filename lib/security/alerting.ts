 ...
 *
 * Sistema de alertas en tiempo real para amenazas de seguridad
 *
 * Canales de alerta:
 * - Email (críticas y resumen diario)
 * - Webhook (Slack, Discord, etc.)
 * - Dashboard en tiempo real (WebSocket)
 * - SMS (solo críticas, opcional)
 */
...
/**
 * Crea y envía una alerta de seguridad
 */
 ...
 */
async function sendDashboardAlert(alertId: string, config: AlertConfig): Promise<void> {
  try {
...
/**
 * Genera y envía resumen diario de seguridad
 */
