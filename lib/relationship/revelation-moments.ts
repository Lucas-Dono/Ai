...
export function adaptRevelationToPersonality(
  ...
  // Introvertidos: revelaciones más sutiles y reservadas
  ...
  // Extrovertidos: revelaciones más expresivas y directas
  ...
  // Alto neuroticismo: más emocionales y con algo de inseguridad
  ...
  // Alta apertura: más reflexivos y conscientes del cambio
  ...
  // Alta conscientiousness: más formales y considerados
