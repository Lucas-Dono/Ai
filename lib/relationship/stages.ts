...
export const MAX_STAGE_BY_PLAN: Record<UserPlan, RelationshipStage> = {
  free: "friend",      // Free: máximo amigo (no puede llegar a close/intimate)
  plus: "close",       // Plus: máximo cercano (no puede llegar a intimate)
  ultra: "intimate",   // Ultra: sin límites
};
...
export function getRelationshipStageComplete(
  ...
  // 2. Encontrar el stage máximo permitido por mensajes
  ...
  // 3. Obtener el stage máximo permitido por plan
