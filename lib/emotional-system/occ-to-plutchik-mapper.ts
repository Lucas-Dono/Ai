...
interface MappingRule {
  ...
  plutchikComponents: Array<{
    ...
    weight: number; // 0-1, qué tanto de la intensidad OCC va a esta emoción Plutchik
  }>;
  description: string;
}
...
const MAPPING_RULES: MappingRule[] = [
...

  {
    ...
    plutchikComponents: [
      ...
      { emotion: "anticipation", weight: -0.4 }, // REDUCIR anticipación
    ],
...

  {
    ...
    plutchikComponents: [
      ...
      { emotion: "sadness", weight: 0.3 },
      { emotion: "anticipation", weight: -0.3 }, // REDUCIR anticipación
    ],
...
export class OCCToPlutchikMapper {
  ...
  mapOCCToPlutchik(occEmotions: EmotionState): PlutchikEmotionState {
    ...
    // Procesar cada emoción OCC activa
