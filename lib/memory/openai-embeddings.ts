 ...
 * text-embedding-3-small - Ultra rápido y económico
 *
 * Pricing: $0.02/M tokens ($0.01/M con batch)
 * Dimensiones: 1536
 * Latencia: ~200-500ms
 */
 ...
 * Batch pricing: $0.01/M tokens (50% descuento)
 */
export async function generateOpenAIEmbeddingsBatch(texts: string[]): Promise<number[][]> {
  ...
  try {
    ...
    // Ordenar por index para asegurar el orden correcto
...
/**
 * Compatibilidad: Alias para generateOpenAIEmbedding
 * Para migración gradual desde Qwen
 */
