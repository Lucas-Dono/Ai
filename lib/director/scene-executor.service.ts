  ...
  private async applyEffect(
    ...
    try {
      switch (effect.type) {
        ...
        case "resolve_seed":
          // Resolver una semilla específica
    ...
    try {
      await prisma.sceneExecution.create({
        data: {
          ...
          participantAgents,
          userMessages: 0, // Se actualizará después si es necesario
        },
      });
