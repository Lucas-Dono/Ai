...
class LoopDetectorService {
  ...
  // Frases que indican cada patrón
  ...
  private detectTopicLoop(messages: GroupMessage[]): LoopPattern | null {
    ...
    // Busca repetición de las mismas palabras clave
    ...
    // Si alguna palabra clave aparece en más del threshold de mensajes
  ...
  private detectProtagonistLoop(
    ...
    // Si alguien tiene más del doble del promedio
