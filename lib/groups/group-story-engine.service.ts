 ...
 *
 * Sistema de narrativa guiada para grupos que:
 * - Genera beats narrativos
 * - Coordina arcos de historia
 * - Gestiona progreso narrativo
 * - Genera scene directions
 */
...
Retorna un JSON con la siguiente estructura:
{
   ...
   */
  private getDefaultStoryArc(aiPersonalities: any[]): StoryArc {
    return {
