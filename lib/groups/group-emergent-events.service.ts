 ...
 *
 * Sistema de eventos emergentes para grupos que:
 * - Genera situaciones inesperadas
 * - Añade variedad y sorpresa
 * - Crea momentos memorables
 * - Se adapta al contexto del grupo
 */
...
export interface EmergentEvent {
  ...
  description: string;
  impact: EventImpact;
  affectedAIs?: string[]; // IDs de IAs afectadas
...
export type EventType =
  | "external_arrival" // Nueva IA o usuario se une temporalmente
  | "mood_shift" // Cambio emocional colectivo
  | "topic_injection" // Tema inesperado surge
  | "time_pressure" // Necesidad de tomar decisión rápida
  | "revelation" // Uno de los miembros revela algo
  | "challenge" // Desafío o dilema aparece
  | "celebration" // Evento positivo colectivo
  | "mystery" // Algo extraño o inexplicable ocurre
  | "technical_glitch"; // Simulación de problema técnico divertido
