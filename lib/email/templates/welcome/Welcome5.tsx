...
export default function Welcome5(props: EmailTemplateData) {
  ...
  return (
    <EmailLayout preview="Desbloquea todo el potencial" unsubscribeUrl={unsubscribeUrl}>
      ...
      <Text style={listItem}>Crea hasta 50 personajes personalizados (vs 5 gratis)</Text>
      <Text style={listItem}>Acceso a mundos virtuales avanzados</Text>
      <Text style={listItem}>Memoria extendida para IAs (10,000 tokens vs 2,000)</Text>
      <Text style={listItem}>Prioridad en tiempos de respuesta</Text>
      <Text style={listItem}>Sin anuncios</Text>

      <Heading style={h2}>Plan Ultra - $19.99/mes</Heading>
      <Text style={listItem}>Todo lo de Plus, más:</Text>
      <Text style={listItem}>Personajes ilimitados</Text>
      <Text style={listItem}>Crea tus propios mundos virtuales</Text>
      <Text style={listItem}>Modelos de IA premium (GPT-4, Claude)</Text>
      <Text style={listItem}>Memoria ilimitada para IAs</Text>
      <Text style={listItem}>API access para desarrolladores</Text>
