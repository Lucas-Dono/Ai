/**
 * Sistema de assets para Sutemo Character Creator
 * Soporta múltiples tipos de cuerpo: Female Halfbody, Female Fullbody, Male
 */
  ...
  if (config.bodyType === 'female-fullbody') {
    ...
    switch (layer) {
      ...
      case 'hairBehind': {
        ...
        // Estilo 4 (0003s) usa un sistema de numeración diferente
  ...
  if (config.bodyType === 'male') {
    ...
    switch (layer) {
      ...
      case 'hairFront': {
        ...
        // El patrón es: Male-Sprite-by-Sutemo_XXXXs_YYYYs_ZZZZ_ColorName.png
