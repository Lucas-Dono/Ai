 ...
 *
 * Orquesta todo el flujo de creación de personajes:
 * 1. Validate draft completo
 * 2. Generate profile con IA
 * 3. Validate coherence
 * 4. Generate eventos, personas, memorias automáticamente
 * 5. Create Agent en BD
 * 6. Create entidades relacionadas
...
/**
 * Orquesta la creación completa de un personaje
 */
export async function createCharacter(
  ...
  try {
    ...
    // - generateStagePrompts() → prompts por relación
...
async function getUserTier(userId: string): Promise<'free' | 'plus' | 'ultra'> {
