 ...
 * Validation Service
 *
 * Servicios de validación para el character creator V2:
 * - Location validation y geocoding
 * - Name validation y character search
 * - Draft validation completa
 */
...
/**
 * Valida y enriquece una ubicación usando geocoding
 *
...
/**
 * Busca personajes en múltiples fuentes
 */
...
async function searchFandom(name: string): Promise<CharacterSearchResult[]> {
