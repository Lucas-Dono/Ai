 ...
 *
 * Cachea datos frecuentemente accedidos para reducir carga en DB:
 * - Bonds activos por usuario
 * - Rankings globales
...
import type { SymbolicBond, BondQueue, AgentBondConfig } from "@prisma/client";
...
/**
 * Cache de bonds activos del usuario
 */
...
/**
 * Cache de configuración de agente
 */
