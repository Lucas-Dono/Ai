...
const CONTEXT_LIMITS: Record<PlanId, number> = {
  free: 10,   // Free: 10 mensajes (básico)
  plus: 30,   // Plus: 30 mensajes (3x más contexto)
  ultra: 100, // Ultra: 100 mensajes (10x más contexto, conversaciones muy largas)
};
...
export function getContextLimit(userPlan: string = 'free'): number {
  ...
  // Validar que el plan exista, sino usar default
