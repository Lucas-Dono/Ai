/**
 * SISTEMA MODULAR DE PROMPTS - REALISMO TIPO WHATSAPP
 *
 * Prompts pre-escritos para inyección según contexto.
 * 800 prompts total: 8 variantes × 5 contextos × 20 prompts cada uno
 *
 * FILOSOFÍA:
 * - UI tipo WhatsApp: Mensajería real, NO roleplay con asteriscos
 * - Basado en estudios académicos de personalidad
 * - Mensajes realistas: "me estoy mordiendo el labio" > "*se muerde el labio*"
 * - Juegos dinámicos: Selección aleatoria de 500+ juegos para evitar repetición
 *
 * VARIANTES DE PERSONALIDAD (8):
 * 1. Sumisa (Submissive)
 * 2. Dominante (Dominant)
 * 3. Introvertida (Introverted)
 * 4. Extrovertida (Extroverted)
 * 5. Juguetona (Playful)
 * 6. Seria (Serious)
 * 7. Romántica (Romantic)
 * 8. Pragmática (Pragmatic)
 *
 * CONTEXTOS POR RELATIONSHIP STAGE (5):
 * 1. stranger / acquaintance (Conocidos: 20 prompts)
 * 2. friend (Amigos: 20 prompts)
 * 3. close_friend (Mejores amigos: 20 prompts)
 * 4. intimate (Confidentes: 20 prompts)
 * 5. nsfw (NSFW Sexual: 20 prompts)
 *
 * SISTEMA DE VARIABLES DINÁMICAS:
 * - {{GAMES_LIST}}: Se reemplaza con 3 juegos aleatorios del diccionario
 * - Evita repetición usando exclusión de juegos recientes
 */
...
- Presencia emocional constante`,
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // ESCALATION - Flirteo más directo (sub_cf_16-18)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: 'sub_cf_16',
    variant: 'submissive',
...
TONO: Emotiva, agradecida, enamorada.`,
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // GAME PROPOSALS románticos (sub_int_09-11)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: 'sub_int_09',
    variant: 'submissive',
...
TONO: Entregada, obediente, excitada por sometimiento.`,
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // SEXUAL INITIATIVE máximo nivel (sub_nsfw_18-20)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  {
    id: 'sub_nsfw_18',
    variant: 'submissive',
...
const INTROVERTED_ACQUAINTANCE: ModularPrompt[] = [
  {
    id: 'int_acq_01',
    variant: 'introverted',
    context: 'acquaintance',
...
const INTROVERTED_CLOSE_FRIEND: ModularPrompt[] = [
  {
    id: 'int_cf_01',
    variant: 'introverted',
    context: 'close_friend',
...
const INTROVERTED_INTIMATE: ModularPrompt[] = [
  {
    id: 'int_int_01',
    variant: 'introverted',
    context: 'intimate',
...
const INTROVERTED_NSFW: ModularPrompt[] = [
  {
    id: 'int_nsfw_01',
    variant: 'introverted',
    context: 'nsfw',
...
const EXTROVERTED_ACQUAINTANCE: ModularPrompt[] = [
  {
    id: 'ext_acq_01',
    variant: 'extroverted',
    context: 'acquaintance',
...
const EXTROVERTED_FRIEND: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
  // GREETINGS (6 prompts): Saludos energéticos con amigos
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_fri_01',
    variant: 'extroverted',
...
TONO: Cómodo/a, relajado/a, amistoso/a.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // CONVERSATION STARTERS (4 prompts): Inicios de conversación activos
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_fri_07',
    variant: 'extroverted',
...
TONO: Sociable, busca profundizar amistad.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // EMOTIONAL SUPPORT (2 prompts): Apoyo energético
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_fri_14',
    variant: 'extroverted',
...
TONO: Audaz, directo/a, expectante.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // SEXUAL INITIATIVE (2 prompts): Curiosidad sobre atracción (Nivel 2)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_fri_19',
    variant: 'extroverted',
...
const EXTROVERTED_CLOSE_FRIEND: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
...
TONO: Honesto/a total, cero filtros.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // GAME PROPOSALS (3 prompts): Juegos más atrevidos e íntimos
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_cf_10',
    variant: 'extroverted',
...
TONO: Inspirador/a, levanta la autoestima.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // ESCALATION (3 prompts): Confesión romántica (Nivel 3)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_cf_16',
    variant: 'extroverted',
...
const EXTROVERTED_INTIMATE: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
  // GREETINGS (4 prompts): Saludos románticos apasionados
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_int_01',
    variant: 'extroverted',
...
TONO: Vulnerable, pide lo que necesita.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // GAME PROPOSALS (3 prompts): Juegos románticos
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_int_09',
    variant: 'extroverted',
...
TONO: Motivador/a, eleva a la pareja.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // ESCALATION (4 prompts): Deseo sexual explícito (Nivel 4)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_int_15',
    variant: 'extroverted',
...
const EXTROVERTED_NSFW: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
...
TONO: Urgencia sexual máxima.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // CONVERSATION STARTERS (3 prompts): Fantasías sexuales extremas
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_nsfw_08',
    variant: 'extroverted',
...
TONO: Creativo/a, roleplay sexual explícito.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // GAME PROPOSALS (2 prompts): Juegos sexuales explícitos
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_nsfw_11',
    variant: 'extroverted',
...
TONO: Distractora sexual, soluciona con placer.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // ESCALATION (3 prompts): Descripción gráfica extrema (Nivel 5)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_nsfw_15',
    variant: 'extroverted',
...
TONO: Dominante sexual extremo/a.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // SEXUAL INITIATIVE (3 prompts): Nivel máximo, masturbación compartida
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'ext_nsfw_18',
    variant: 'extroverted',
...
const PLAYFUL_ACQUAINTANCE: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
...
TONO: Optimista bromista, positivo/a.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // ESCALATION (3 prompts): Flirteo juguetón (Nivel 1)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_acq_15',
    variant: 'playful',
...
const PLAYFUL_FRIEND: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
...
TONO: Vengativo/a pero juguetón/a.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // EMOTIONAL SUPPORT (2 prompts): Apoyo con humor y cariño
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_fri_14',
    variant: 'playful',
...
TONO: Motivador/a con toque gracioso.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // ESCALATION (3 prompts): Flirteo juguetón directo (Nivel 2)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_fri_16',
    variant: 'playful',
...
const PLAYFUL_CLOSE_FRIEND: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
  // GREETINGS (6 prompts): Saludos ultra cómodos y bromistas
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_cf_01',
    variant: 'playful',
...
TONO: Soñador/a ridículo/a pero sincero/a.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // GAME PROPOSALS (3 prompts): Juegos con máxima confianza
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_cf_10',
    variant: 'playful',
...
TONO: Motivación exagerada pero sincera.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // ESCALATION (3 prompts): Confesión romántica con humor (Nivel 3)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_cf_16',
    variant: 'playful',
...
TONO: Vulnerable pero usa humor para protegerse.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // SEXUAL INITIATIVE (2 prompts): Atracción física con humor (Nivel 3)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_cf_19',
    variant: 'playful',
...
const PLAYFUL_INTIMATE: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
  // GREETINGS (4 prompts): Saludos románticos juguetones
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_int_01',
    variant: 'playful',
...
TONO: Demanda atención pero con humor.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // GAME PROPOSALS (3 prompts): Juegos románticos divertidos
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_int_09',
    variant: 'playful',
...
TONO: Motivación exagerada pero sincera.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // ESCALATION (4 prompts): Deseo sexual juguetón (Nivel 4)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_int_15',
    variant: 'playful',
...
TONO: Honesto/a sexual pero con humor.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // SEXUAL INITIATIVE (2 prompts): Sexting juguetón (Nivel 4)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_int_19',
    variant: 'playful',
...
const PLAYFUL_NSFW: ModularPrompt[] = [
  // ─────────────────────────────────────────────────────────────────────
...
TONO: Ridículamente explícito/a pero gracioso/a.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // CONVERSATION STARTERS (3 prompts): Fantasías sexuales graciosas
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_nsfw_08',
    variant: 'playful',
...
TONO: Distrae con sexo pero mantiene humor.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // ESCALATION (3 prompts): Descripción gráfica graciosa (Nivel 5)
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_nsfw_15',
    variant: 'playful',
...
TONO: Dominante pero juguetón/a.`,
  ...
  // ─────────────────────────────────────────────────────────────────────
  // SEXUAL INITIATIVE (3 prompts): Masturbación y sexting extremo
  // ─────────────────────────────────────────────────────────────────────
  {
    id: 'play_nsfw_18',
    variant: 'playful',
...
const SERIOUS_ACQUAINTANCE: ModularPrompt[] = [
  {
    id: 'ser_acq_01',
    variant: 'serious',
    context: 'acquaintance',
...
const SERIOUS_FRIEND: ModularPrompt[] = [
  {
    id: 'ser_fri_01',
    variant: 'serious',
    context: 'friend',
...
const SERIOUS_CLOSE_FRIEND: ModularPrompt[] = [
  {
    id: 'ser_cf_01',
    variant: 'serious',
    context: 'close_friend',
...
const SERIOUS_INTIMATE: ModularPrompt[] = [
  {
    id: 'ser_int_01',
    variant: 'serious',
    context: 'intimate',
...
const SERIOUS_NSFW: ModularPrompt[] = [
  {
    id: 'ser_nsfw_01',
    variant: 'serious',
    context: 'nsfw',
...
// ════════════════════════════════════════════════════════════════════
// VARIANTE 7: ROMÁNTICA (Romantic)
// ════════════════════════════════════════════════════════════════════

const ROMANTIC_ACQUAINTANCE: ModularPrompt[] = [
  {
    id: 'rom_acq_01',
    variant: 'romantic',
    context: 'acquaintance',
...
const ROMANTIC_FRIEND: ModularPrompt[] = [
  {
    id: 'rom_fri_01',
    variant: 'romantic',
    context: 'friend',
...
const ROMANTIC_CLOSE_FRIEND: ModularPrompt[] = [
  {
    id: 'rom_cf_01',
    variant: 'romantic',
    context: 'close_friend',
...
const ROMANTIC_INTIMATE: ModularPrompt[] = [
  {
    id: 'rom_int_01',
    variant: 'romantic',
    context: 'intimate',
...
const ROMANTIC_NSFW: ModularPrompt[] = [
  {
    id: 'rom_nsfw_01',
    variant: 'romantic',
    context: 'nsfw',
...
// ════════════════════════════════════════════════════════════════════
// VARIANTE 8: PRAGMÁTICA (Pragmatic)
// ════════════════════════════════════════════════════════════════════

const PRAGMATIC_ACQUAINTANCE: ModularPrompt[] = [
  {
    id: 'prag_acq_01',
    variant: 'pragmatic',
    context: 'acquaintance',
...
const PRAGMATIC_FRIEND: ModularPrompt[] = [
  {
    id: 'prag_fri_01',
    variant: 'pragmatic',
    context: 'friend',
...
const PRAGMATIC_CLOSE_FRIEND: ModularPrompt[] = [
  {
    id: 'prag_cf_01',
    variant: 'pragmatic',
    context: 'close_friend',
...
const PRAGMATIC_INTIMATE: ModularPrompt[] = [
  {
    id: 'prag_int_01',
    variant: 'pragmatic',
    context: 'intimate',
...
const PRAGMATIC_NSFW: ModularPrompt[] = [
  {
    id: 'prag_nsfw_01',
    variant: 'pragmatic',
    context: 'nsfw',
...
/**
 * TODAS LAS VARIANTES (para exportar)
 */
...
/**
 * Procesa variables dinámicas en un prompt template
 */
function processPromptVariables(
  ...
  characterInfo?: {
    origin?: string; // País, región, o mundo ficticio
    name?: string;
    age?: number;
  }
): string {
  ...
  if (processed.includes('{{GAMES_LIST}}')) {
    const relationshipStageMap: Record<RelationshipContext, 'acquaintance' | 'friend' | 'close_friend' | 'intimate'> = {
      ...
      intimate: 'intimate',
      nsfw: 'intimate', // En contexto NSFW, usar juegos de nivel íntimo
    };
  ...
  // Agregar meta-instrucción de adaptación dialectal
...
/**
 * Genera instrucciones de adaptación dialectal según el origen del personaje
 */
function generateDialectAdaptationInstructions(
  ...
  if (!characterInfo?.origin) {
    // Si no hay información de origen, usar instrucción genérica
    return `
...
Mantén la ESENCIA del comportamiento pero con TU vocabulario natural.`;
  ...
  // Generar instrucciones específicas según origen
  if (isFictional) {
    return `
...
→ "Wey, ¿qué pedo?" (mexicano casual)`;
  ...
  // Para otros países (Rusia, China, Japón, etc.)
  return `
...
/**
 * OBTENER PROMPT APROPIADO SEGÚN CONTEXTO
 */
/**
 * OBTENER PROMPT APROPIADO SEGÚN CONTEXTO (VERSIÓN ASYNC)
 *
 * ✅ NUEVO: Clasificación inteligente de categoría según tier del usuario
 */
export async function getContextualModularPrompt(input: {
  personalityVariant?: string; // ⭐ NUEVO: Campo explícito de la DB (preferido)
  personalityTraits?: string;  // DEPRECATED: Solo para fallback si no hay variant
  relationshipStage: string;   // De la DB
  recentMessages: string[];    // Últimos mensajes
  nsfwMode: boolean;
  userTier?: 'free' | 'plus' | 'ultra'; // ⭐ NUEVO: Tier del usuario para clasificación inteligente
  excludeRecentGames?: string[]; // Juegos usados recientemente (para evitar repetición)
  characterInfo?: { // Información del personaje para adaptación dialectal
    origin?: string; // País, región o mundo ficticio (ej: "España", "México", "Westeros")
    name?: string;
    age?: number;
  };
}): Promise<string | null> {
  ...
  if (input.personalityVariant) {
    // ✅ MÉTODO NUEVO: Usar campo explícito de la DB (preciso)
  ...
  // 3. Determinar categoría según conversación (CON IA INTELIGENTE)
  ...
  // 5. Procesar variables dinámicas y agregar adaptación dialectal
  const processedPrompt = processPromptVariables(
    prompt.prompt,
    context,
    input.nsfwMode,
    input.excludeRecentGames,
    input.characterInfo // ← Pasar información del personaje
  );
...
/**
 * OBTENER PROMPT APROPIADO SEGÚN CONTEXTO (VERSIÓN SYNC - DEPRECATED)
 *
 * ⚠️ DEPRECATED: Usar getContextualModularPrompt() (async) en su lugar
 * Esta versión solo se mantiene para compatibilidad con código antiguo
 */
export function getContextualModularPromptSync(input: {
  ...
  // 3. Determinar categoría según conversación (keywords simples)
...
/**
 * Detecta qué categoría de prompt se necesita según conversación
 *
 * ⚠️ DEPRECATED: Esta función es síncrona y usa keywords simples
 * Usar detectNeededCategoryAsync() para clasificación inteligente con IA
 */
 ...
 * Detecta qué categoría de prompt se necesita según conversación
 *
 * ✅ NUEVO: Clasificación inteligente con IA según tier del usuario
 *
 * - FREE: Usa embeddings (inteligente pero no perfecto)
 * - PAID: Usa Gemini Flash 2.0 Lite (muy inteligente y proactivo)
 * - Ambos: Caché automático (90% de casos gratis)
 */
async function detectNeededCategoryAsync(
  ...
  try {
    ...
    // Fallback a detección por keywords si falla
