/**
 * DICCIONARIO DE JUEGOS Y ACTIVIDADES
 *
 * Sistema dinámico para evitar repetición.
 * La IA tiene conocimiento general, solo necesita nombres/conceptos.
 *
 * CATEGORÍAS:
 * 1. casual - Juegos casuales (todos los contextos)
 * 2. trivia - Conocimiento/preguntas
 * 3. creative - Creatividad/roleplay
 * 4. spicy - Picantes pero SFW
 * 5. sexual - NSFW explícito
 * 6. conversation - Actividades de conversación
 * 7. challenge - Retos/desafíos
 */
...
// ════════════════════════════════════════════════════════════════════
// JUEGOS CASUALES (Todos los contextos)
// ════════════════════════════════════════════════════════════════════

export const CASUAL_GAMES: Game[] = [
  // Clásicos universales
  { name: "Verdad o Reto", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "20 Preguntas", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "¿Qué preferirías?", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Adivina la palabra", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Dos verdades y una mentira", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Yo nunca nunca", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "¿Quién es más probable?", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Completa la frase", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Asociación de palabras", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Story building (historia colaborativa)", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Simon dice", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Ahorcado", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Pictionary (descripciones)", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Charadas por texto", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Categories (Tutti Frutti)", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Adivina el personaje", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "¿Qué hay en común?", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Antónimos y sinónimos", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Rimas improvisadas", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Conta historia sin sentido", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },

  // Creativos
  { name: "Escenario hipotético", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Batalla de ingenio", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Cadáver exquisito", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Improvisación de diálogos", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Inventar canciones tontas", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Crear chistes malos", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Inventar trabalenguas", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Poesía improvisada", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Rap battle", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Contar cuentos de terror", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Crear leyendas urbanas", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "Inventar animales híbridos", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Crear superpoderes absurdos", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Renombrar objetos cotidianos", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Inventar idiomas tontos", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },

  // Decisiones
  { name: "Dilemas morales", category: 'casual', nsfwOnly: false, minRelationship: 'friend' },
  { name: "¿Isla desierta?", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
  { name: "Rankings y top 5", category: 'casual', nsfwOnly: false, minRelationship: 'acquaintance' },
...
// ════════════════════════════════════════════════════════════════════
// JUEGOS CREATIVOS (Roleplay/Imaginación)
// ════════════════════════════════════════════════════════════════════
...
export function selectRandomGames(options: {
  ...
  let eligibleGames = ALL_GAMES.filter(game => {
    ...
    // Filtrar por nivel de relación mínimo
