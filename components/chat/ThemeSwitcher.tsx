    ...
    <div className={cn("relative", className)}>
      ...
      {showMenu && (
        <>
          ...
          {/* Menu */}
          <div className="absolute right-0 top-full mt-2 bg-[#1f1f1f] border border-[#2a2a2a] rounded-2xl shadow-xl z-50 p-3 min-w-[200px]">
            ...
            <div className="space-y-2">
              {themeOptions.map((option) => (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center gap-3 px-3 py-2 rounded-2xl transition-colors",
