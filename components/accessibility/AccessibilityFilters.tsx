 ...
 * These filters are applied via CSS to simulate different types of color vision deficiencies
 */
export function AccessibilityFilters() {
  return (
    ...
    >
      <defs>
        {/* Protanopia Filter - Red deficiency */}
        ...
        {/* Deuteranopia Filter - Green deficiency */}
        ...
        {/* Tritanopia Filter - Blue deficiency */}
