    ...
    return (
      <section className="mb-8">
        ...
        <div className="text-center py-12 bg-gray-800/30 rounded-2xl border border-gray-700/50">
          <p className="text-gray-400 mb-2">No tienes conversaciones recientes</p>
          <p className="text-sm text-gray-500">Inicia un chat con tus compañeros para verlos aquí</p>
        </div>
      </section>
    );
  }
