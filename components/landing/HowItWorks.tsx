              ...
              <div className="flex">
                {steps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      <Card className="p-5 h-full border border-border hover:border-foreground/20 transition-all duration-300 group bg-card/50 backdrop-blur-sm">
                        {/* Step number */}
                        <div className="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-muted mb-4">
                        ...
                        {/* Icon */}
                        <div className="mb-4">
                          <div className="w-10 h-10 rounded-xl bg-foreground/5 flex items-center justify-center group-hover:bg-foreground group-hover:text-background transition-colors duration-300">
