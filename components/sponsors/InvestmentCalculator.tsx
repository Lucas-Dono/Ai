...
export function InvestmentCalculator() {
  ...
  return (
    <section id="investment-calculator" className="py-24 sm:py-32 relative overflow-hidden bg-gradient-to-b from-background via-muted/20 to-background">
      <div className="container mx-auto px-4">
        ...
        >
          <Card className="p-8 md:p-12 border-2 border-foreground/10 bg-card shadow-2xl">
            ...
            <div className="mb-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-3xl font-bold text-foreground">
                  ...
                  {investment >= 5000 && <span className="text-lg text-foreground/60"> USD/mes</span>}
                </div>
              </div>
              <Slider
                value={[investment]}
            ...
            {!isEnterprise ? (
              <div className="pt-8 border-t-2 border-border">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="p-4 rounded-xl bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800">
                    <div className="text-sm text-foreground/70 mb-1 font-medium">
                      Impresiones Totales
                    </div>
              ...
              <div className="pt-8 border-t-2 border-border">
                <div className="bg-blue-50 dark:bg-blue-950/20 border-2 border-blue-200 dark:border-blue-800 rounded-2xl p-8 text-center">
            ...
            {/* Bottom Note */}
            <div className="mt-8 p-4 bg-blue-50/50 dark:bg-blue-950/10 rounded-xl border border-blue-200 dark:border-blue-800">
