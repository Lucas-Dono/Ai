...
export default function TerminosPage() {
  ...
  const sections = [
    ...
    { id: "service", number: "2" },
    { id: "accounts", number: "3", subsections: ["registration", "ageVerification", "security"] },
    { id: "content", number: "4", subsections: ["userContent", "nsfw", "prohibited"] },
    { id: "privacy", number: "5", subsections: ["encryption", "dataProtection"] },
    { id: "billing", number: "6", subsections: ["plans", "payment", "cancellation"] },
    { id: "ip", number: "7", subsections: ["platform", "user", "license"] },
    { id: "aiLimitations", number: "8" },
    { id: "sponsors", number: "9" },
    { id: "liability", number: "10" },
    { id: "indemnification", number: "11" },
    { id: "modifications", number: "12" },
    { id: "termination", number: "13" },
    { id: "jurisdiction", number: "14" },
    { id: "general", number: "15" },
    { id: "contact", number: "16" },
  ];
