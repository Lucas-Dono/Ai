 ...
 *
 * POST /api/demo/chat
 * - Chat demo sin autenticación
 * - Sesiones efímeras en Redis
 * - Solo permite chat con Luna
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    let lunaAgent = await prisma.agent.findFirst({
      where: {
        OR: [
          { id: DEMO_LUNA_ID },
    ...
    // 7. Actualizar sesión con nuevo mensaje y estado
...
/**
 * GET /api/demo/chat
 * Obtener información de la demo
 */
