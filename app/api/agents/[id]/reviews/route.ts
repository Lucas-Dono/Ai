...
export async function GET(
  ...
  try {
    ...
    // Ocultar información sensible del usuario (solo mostrar iniciales)
    const sanitizedReviews = reviews.map((review) => ({
      ...
      // No incluimos userId por privacidad, o lo reemplazamos con iniciales
