/**
 * API Admin - Dashboard
 * Estadísticas principales (KPIs) del sistema
 */
 ...
 * Obtiene estadísticas principales del sistema
 */
export const GET = withAdminAuth(async (request, { admin }) => {
  try {
    ...
    const [
      ...
      // Mensajes (aproximación - limitar a últimos 30 días por performance)
      messagesStats,
      ...
      // Mensajes (solo últimos 30 días para performance)
