...
// SECURITY: Verificar que la petición viene de un cron autorizado
function verifyCronAuth(req: NextRequest): boolean {
  ...
  // Verificar que el header coincide con el secret
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Verificar que el sistema proactivo está habilitado
    ...
    // Enviar alertas si hay muchos errores
    if (errors > 10) {
...
// También permitir GET para testing manual en el navegador (solo en desarrollo)
