...
export async function GET(
  ...
  try {
    ...
    // Verificar que el usuario puede invitar a este grupo
    ...
    // Buscar otros usuarios si hay query (no solo amigos)
    let otherUsers: any[] = [];
    if (query) {
    ...
    // Obtener invitaciones pendientes para este grupo
    ...
    // Crear mapa de usuarios invitados
...
export async function POST(
  ...
  try {
    ...
    // Verificar que el usuario invitado no está ya en el grupo
...
export async function DELETE(
  ...
  try {
    ...
    // Verificar que la invitación existe y pertenece a este grupo
    ...
    // Verificar que el usuario tiene permiso (es el invitador o admin/owner del grupo)
