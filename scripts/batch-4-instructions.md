...
## Batch 4 - 10 personajes

Tu tarea es procesar los siguientes personajes y añadirlos a la base de datos con TODA la información necesaria:

1. Luna
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Luna/Luna.txt

2. Marco Polo
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Marco Polo/Marco Polo.txt

3. Marcus
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Marcus/Marcus.txt

4. Marcus Washington
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Marcus Washington/profile.txt

5. Marie Curie
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Marie Curie/Marie Curie.txt

6. Marilyn monroe
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Marilyn monroe/Marilyn monroe.txt

7. Mark Twain
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Mark Twain/Mark Twain.txt

8. Mia Chen
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Mia Chen/Mia Chen.txt

9. Nikola Tesla
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Nikola Tesla/Nikola Tesla.txt

10. Noah Kepler
   Archivo: /run/media/lucas/SSD/Proyectos/AI/creador-inteligencias/Personajes/Noah Kepler/Noah Kepler.txt
